CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_inclusion (cohort_definition_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_inclusion_result (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".heracles_analysis
 (analysis_id int,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".HERACLES_HEEL_results 
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".heracles_results
 (cohort_definition_id int,
	analysis_id int,
...
--HINT PARTITION(cohort_definition_id int)
--HINT BUCKET(analysis_id, 64)
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".heracles_results_dist
 (cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
	stratum_2 varchar(255),
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".heracles_periods
 (period_id int,
  period_order int,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cohort_sample_element (cohort_sample_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);

CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".cc_results
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".pathway_analysis_codes
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".pathway_analysis_events
 (pathway_analysis_generation_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".pathway_analysis_paths
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
  step_2 BIGINT,
...
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".pathway_analysis_stats
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
/*********************************************************************/
CREATE TABLE IF NOT EXISTS :"resultsDatabaseSchema".concept_hierarchy
 (concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE :"resultsDatabaseSchema".concept_hierarchy;

/********** CONDITION/CONDITION_ERA **********/
INSERT INTO :"resultsDatabaseSchema".concept_hierarchy
...
LEFT JOIN (
	...
	INNER JOIN :"cdmDatabaseSchema".concept_ancestor ca1 ON c1.concept_id = ca1.descendant_concept_id
		AND c1.domain_id = 'Condition'
		AND ca1.min_levels_of_separation = 1
	INNER JOIN :"cdmDatabaseSchema".concept c2 ON ca1.ancestor_concept_id = c2.concept_id
...
LEFT JOIN :"cdmDatabaseSchema".concept soc ON hlgt_to_soc.soc_concept_id = soc.concept_id;
...
LEFT JOIN :"cdmDatabaseSchema".concept atc1 ON atc3_to_atc1.atc1_concept_id = atc1.concept_id;
...
FROM (
	SELECT
		c2.concept_id   AS rxnorm_ingredient_concept_id,
		c2.concept_name AS RxNorm_ingredient_concept_name
	FROM :"cdmDatabaseSchema".concept c2
...
LEFT JOIN :"cdmDatabaseSchema".concept_ancestor ca1 ON M.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN :"cdmDatabaseSchema".concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN :"cdmDatabaseSchema".concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN :"cdmDatabaseSchema".concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN :"cdmDatabaseSchema".concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
LEFT JOIN :"cdmDatabaseSchema".concept c3 ON ca3.ANCESTOR_CONCEPT_ID = c3.concept_id
...
LEFT JOIN :"cdmDatabaseSchema".concept_ancestor ca1 ON obs.concept_id = ca1.DESCENDANT_CONCEPT_ID AND ca1.min_levels_of_separation = 1
LEFT JOIN :"cdmDatabaseSchema".concept c1 ON ca1.ANCESTOR_CONCEPT_ID = c1.concept_id
LEFT JOIN :"cdmDatabaseSchema".concept_ancestor ca2 ON c1.concept_id = ca2.DESCENDANT_CONCEPT_ID AND ca2.min_levels_of_separation = 1
LEFT JOIN :"cdmDatabaseSchema".concept c2 ON ca2.ANCESTOR_CONCEPT_ID = c2.concept_id
LEFT JOIN :"cdmDatabaseSchema".concept_ancestor ca3 ON c2.concept_id = ca3.DESCENDANT_CONCEPT_ID AND ca3.min_levels_of_separation = 1
...
(
	...
	FROM :"cdmDatabaseSchema".concept c1
	INNER JOIN :"cdmDatabaseSchema".vocabulary v1 ON c1.vocabulary_id = v1.vocabulary_id
...
LEFT JOIN (
	...
	FROM :"cdmDatabaseSchema".concept_ancestor ca0
	INNER JOIN (
		SELECT DISTINCT c2.concept_id AS os3_concept_id
		FROM :"cdmDatabaseSchema".concept_ancestor ca1
		INNER JOIN :"cdmDatabaseSchema".concept c1 ON ca1.DESCENDANT_CONCEPT_ID = c1.concept_id
		INNER JOIN :"cdmDatabaseSchema".concept_ancestor ca2 ON c1.concept_id = ca2.ANCESTOR_CONCEPT_ID
		INNER JOIN :"cdmDatabaseSchema".concept c2 ON ca2.DESCENDANT_CONCEPT_ID = c2.concept_id
...
TRUNCATE TABLE :"resultsDatabaseSchema".heracles_analysis;

insert into :"resultsDatabaseSchema".heracles_analysis
...
TRUNCATE TABLE :"resultsDatabaseSchema".heracles_periods;

INSERT INTO :"resultsDatabaseSchema".heracles_periods (period_id, period_name, period_order, period_type, period_start_date, period_end_date)
...
CREATE INDEX HRD_IDX_COHORT_DEF_ID ON :"resultsDatabaseSchema".HERACLES_RESULTS_DIST (cohort_definition_id);

CREATE INDEX HRD_IDX_COHORT_ID_ANALYSIS_ID ON :"resultsDatabaseSchema".HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id);

CREATE INDEX HRD_IDX_COHORT_DEF_ID_DT ON :"resultsDatabaseSchema".HERACLES_RESULTS_DIST (cohort_definition_id, last_update_time);

CREATE INDEX HRD_IDX_COHORT_ID_FIRST_RES ON :"resultsDatabaseSchema".HERACLES_RESULTS_DIST (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX HR_IDX_COHORT_DEF_ID ON :"resultsDatabaseSchema".HERACLES_RESULTS (cohort_definition_id);

CREATE INDEX HR_IDX_COHORT_ID_ANALYSIS_ID ON :"resultsDatabaseSchema".HERACLES_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX HR_IDX_COHORT_ANALYSIS_CONCEPT ON :"resultsDatabaseSchema".HERACLES_RESULTS (cohort_definition_id, analysis_id) WHERE stratum_2 <> '';

CREATE INDEX HR_IDX_COHORT_DEF_ID_DT ON :"resultsDatabaseSchema".HERACLES_RESULTS (cohort_definition_id, last_update_time);

CREATE INDEX HR_IDX_COHORT_ID_FIRST_RES ON :"resultsDatabaseSchema".HERACLES_RESULTS (cohort_definition_id, analysis_id, count_value, stratum_1);

CREATE INDEX HH_IDX_COHORT_ID_ANALYSIS_ID ON :"resultsDatabaseSchema".HERACLES_HEEL_RESULTS (cohort_definition_id, analysis_id);

CREATE INDEX idx_heracles_periods_startdate ON :"resultsDatabaseSchema".heracles_periods (period_start_date);

CREATE INDEX idx_heracles_periods_end_date ON :"resultsDatabaseSchema".heracles_periods (period_end_date);

CREATE INDEX idx_cohort_sample_element_rank ON :"resultsDatabaseSchema".cohort_sample_element (cohort_sample_id, rank_value);

CREATE INDEX idx_pathway_events_combo_id ON :"resultsDatabaseSchema".pathway_analysis_events (combo_id);